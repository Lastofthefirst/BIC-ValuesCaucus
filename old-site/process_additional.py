#!/usr/bin/env python3
"""
Script to convert additional Wayback Machine downloaded files to the browsable offline site
with relative links and merge them with existing content.
"""
...
if __name__ == "__main__":
    input_dir = "scrape/2021-09-22/mirror-additional"
    output_dir = "scrape/2021-09-22/offline-site"
    
    clean_wayback_structure(input_dir, output_dir)
    print("Additional files conversion complete. Check the offline-site directory.")