#!/usr/bin/env python3
"""
Script to convert Wayback Machine downloaded files to a browsable offline site
with relative links.
"""
...
if __name__ == "__main__":
    input_dir = "scrape/2021-09-22/mirror"
    output_dir = "scrape/2021-09-22/offline-site"
    
    clean_wayback_structure(input_dir, output_dir)
    print("Conversion complete. Check the offline-site directory.")